...
# SQL query to select data on the number of stops for each gender, grouped by stop type
...
# bar chart to compare traffic stops between genders
...
stop_type_gender |> 
  ...
  labs(title = "Traffic Stops by Gender in Los Angeles Dec 2009 - Jun 2018", 
       x = "Subject Gender", 
       y = "Stop Count",
       alt = "Bar chart comparing the traffic stops that occurred in Los Angeles 
       between Dec 2009 and Jun 2018 between genders, and distinguishing between stop type. 
       There were significantly more males that were stopped, both in vehicules and 
       as pedestrians") +
...
# sql query selecting total stops, searches, and instances of contraband found
...
# creating a line graph with a series for different stop instances
...
long_df |> 
  ...
  labs(title = "Traffic Stops by Time of Day in New Orleans Dec 2009 - Jul 2018", 
       x = "Hour", 
       y = "Count",
       alt = "Line graph with a series depicting total stop count, searches, and contraband
       found respectively, over the course of the 24 hour day, as documented in 
       New Orleans between December 2009 and July 2018. All three metrics were at their 
       lowest around 6 a.m., with total stops peaking around 3 p.m.")
...
# sql query selecting subject age and relevant stop count
...
gender_stops |> 
  ...
  labs(title = "Traffic Stops by Subject Age and Gender in Nashville Dec 2009 - Mar 2019", 
       x = "Subject Age", 
       y = "Stop Count",
       alt = "Line graph depicting traffic stops by age, with two series for females 
       and males respectively, as recorded in Nashville between December 2009 and March 2019.
       Both genders peak around 25 years of ages, and stop rates gradually sink as 
       subjects get older.")
